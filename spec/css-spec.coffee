describe 'CSS grammar', ->
  ...
  describe 'selectors', ->
    ...
    it 'tokenises combinators', ->
      {tokens} = grammar.tokenizeLine 'a > b + * ~ :not(.nah)'
    ...
    describe 'attribute selectors', ->
      ...
      it 'tokenises quoted strings in attribute selectors', ->
      ...
      it 'tokenises unquoted strings in attribute selectors', ->
        {tokens} = grammar.tokenizeLine('span[class~=Java]')
        expect(tokens[3]).toEqual value: '~=', scopes: ['source.css', 'meta.selector.css', 'meta.attribute-selector.css', 'keyword.operator.pattern.css']
      ...
      it 'tokenises attribute selectors spanning multiple lines', ->
        lines = grammar.tokenizeLines """
          span[
            \\x20{2}
            ns|lang/**/
    ...
    describe 'pseudo-classes', ->
      ...
      describe ':not()', ->
        it 'tokenises other selectors inside :not()', ->
          {tokens} = grammar.tokenizeLine('*:not(.class-name):not(div) {}')
          expect(tokens[1]).toEqual value: ':', scopes: ['source.css', 'meta.selector.css', 'entity.other.attribute-name.pseudo-class.css', 'punctuation.definition.entity.css']
        ...
        it 'tokenises injected comments', ->
          {tokens} = grammar.tokenizeLine('*:not(/*(*/.class-name/*)*/):not(/*b*/) {}')
          expect(tokens[2]).toEqual value: 'not', scopes: ['source.css', 'meta.selector.css', 'entity.other.attribute-name.pseudo-class.css']
          expect(tokens[3]).toEqual value: '(', scopes: ['source.css', 'meta.selector.css', 'punctuation.section.function.begin.bracket.round.css']
  ...
  describe 'property lists (declaration blocks)', ->
    ...
    it 'tokenises commas between property values', ->
    ...
    describe 'values', ->
      ...
      it 'tokenises numeric values correctly', ->
        lines = grammar.tokenizeLines """
          .a   { a:       12em  }
          .a   { a:     4.01ex  }
          .a   { a:   -456.8ch  }
      ...
      describe 'functional notation', ->
        describe 'attr()', ->
          it 'tokenises parameters correctly and case-insensitively', ->
            {tokens} = grammar.tokenizeLine('a{content:aTTr(data-width px, inherit)}')
          ...
          it 'matches variables', ->
            {tokens} = grammar.tokenizeLine('a{content:ATTR(VAR(--name) px, "N/A")}')
            expect(tokens[4]).toEqual value: 'ATTR', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.misc.css', 'support.function.misc.css']
            expect(tokens[5]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.misc.css', 'punctuation.section.function.begin.bracket.round.css']
        ...
        describe 'calc()', ->
          ...
          it 'requires whitespace around + and - operators', ->
            {tokens} = grammar.tokenizeLine('a{ width: calc(3px+1em); }')
          ...
          it 'does not require whitespace around * and / operators', ->
          ...
          it 'matches variable expansions inside calculations', ->
            {tokens} = grammar.tokenizeLine('.foo { margin-top: calc(var(--gap) + 1px); }')
        ...
        describe 'colours', ->
          it 'tokenises colour functions correctly', ->
          ...
          it 'matches variables as colour components', ->
            {tokens} = grammar.tokenizeLine('a{ color: RGBA(var(--red), 0% , 20%, .2)}')
            expect(tokens[7]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.css', 'punctuation.section.function.begin.bracket.round.css']
          ...
          it 'matches comments between colour components', ->
            {tokens} = grammar.tokenizeLine('a{ color: rgba(/**/255/*=*/,0,/*2.2%*/51/*,*/0.2)}')
          ...
          it 'allows colour components to be split across lines', ->
            lines = grammar.tokenizeLines """
              .frost{
        ...
        describe 'other functions', ->
          ...
          it 'tokenises OpenType feature functions', ->
            lines = grammar.tokenizeLines """
              .font{
        ...
        describe 'timing-functions', ->
          it 'tokenises them correctly', ->
            {tokens} = grammar.tokenizeLine('a{ zoom: cubic-bezier(/**/1.2,/*=*/0,0,0/**/)}')
          ...
          it 'highlights the "start" and "end" keywords', ->
            {tokens} = grammar.tokenizeLine('a{ before: steps(0, start); after: steps(1, end); }')
        ...
        describe 'variables', ->
          it 'scopes var() statements as variables', ->
          ...
          it 'allows injected comments', ->
            {tokens} = grammar.tokenizeLine('a{ color: var( /*=*/ --something ) }')
          ...
          it 'tokenises fallback values', ->
            {tokens} = grammar.tokenizeLine('.bar{ width: var(--page-width, /*;;;);*/ 2); }')
